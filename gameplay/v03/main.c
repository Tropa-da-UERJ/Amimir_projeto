...
int main(void) {
    ...
    while (running) {
        ...
        if (currentState == STATE_PLAYING) {
            ...
            handleMenuInput(&currentState, &running); // <-- NOVO
        } else if (currentState == STATE_END) {
            handleEndInput(&currentState, &running); // <-- NOVO
        }
